...
<body>
    <div class = 'main'>
        ...
        <div class = 'content'>
            ...
            <a href='../General/info.php'><button class = 'btn' name = 'peserta' > Maklumat Diri </button></a>
            <br><br>
            <a href='keputusanPeserta.php'><button class = 'btn'> Keputusan Pertandingan </button></a>
            <br><br>
